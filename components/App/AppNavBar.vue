     ...
     >
       <li v-for="item in items" :key="item.path">
         ...
         >
           ...
           >
             <UIcon aria-hidden="true" :name="item.icon" class="w-5 h-5 z-10" dynamic/>
             <span
...
const items = [
 { name: "首页", path: "/", icon: "i-solar-home-smile-outline" },
 {
   name: "项目",
   path: "/projects",
 ...
 { name: "留言板", path: "/message-board", icon: "i-solar-chat-round-line-linear" },
 {
   name: "有趣的分享",
   path: "/share",
